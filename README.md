...
- Other workflow based pipelines. From my own experience I tried running HiCPro without realizing that HiCPro was a workflow itself. For tools which are workflows it might be better to use them independently rather than connecting them correctly in Snakemake. My stance is not completely set on this but I'm leaning very hard on this opinion for now.
